...
//	try (var fis = new FileInputStream("SerTest.ser"); var ois = new ObjectInputStream(fis)) {
//	  var deserializedXmen = (Xmen) ois.readObject();
	try (FileInputStream fis = new FileInputStream("SerTest.ser"); ObjectInputStream ois = new ObjectInputStream(fis)) {
	  Xmen deserializedXmen = (Xmen) ois.readObject();
